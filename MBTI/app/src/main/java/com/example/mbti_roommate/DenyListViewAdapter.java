...
public class DenyListViewAdapter extends ArrayAdapter<UserInfo> implements View.OnClickListener{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = inflater.inflate(R.layout.profile_deny, parent, false);
        ...
        Button cancelButton = convertView.findViewById(R.id.deny_cancel_btn);
        final int Pos = position;
        ...
        Button showButton = (Button) convertView.findViewById(R.id.profile_deny_show_btn);
            ...
            public void onResponse(String response) {
                if(!response.isEmpty()){
                    try {
                        ...
                        if(isSuccessed) {
                            Toast info= Toast.makeText(context,"차단을 해제하였습니다.",Toast.LENGTH_LONG);
                            info.show();
                        }
                        else{
